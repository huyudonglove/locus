...
<script>
import {upSdk} from "../http/request";
    ...
    fileSelect() {
      ...
      //上传sdk
          ...
          name[1]=='unitypackage'?(()=>{
            ...
            upSdk(form).then(res=>{
              res.code?this.$message.error(res.msg):(()=>{
                ...
                this.inputPackage = res.data.originFileName;
                this.size=res.data.size;
                this.$emit('getSdkId',res.data.fileId,this.inputPackage,this.size,res.data.durationTime,'sdk');
              })();
              loading.close();
            })
        ...
        this.type=='pdf'?(()=>{
          ...
          })():this.$message.error('文档格式错误，必须为pdf');
        })():'';
      };
    }
  }

<template>
  <div>
    ...
    <el-table ref="ReplaceRef" :data="table" style="width: 100%" class="mt15 mb15" :max-height="tableHeight" @sort-change="changeTableSort" :header-cell-style="headerCellStyle" :cell-style="cellStyle">

<template>
  <div>
    <div style="height:50px;border-bottom:1px solid #DFDCDC;margin-bottom:10px;">
      <el-page-header @back="$router.push({path:'/service/apikeyList',query:JSON.parse($route.query.oldQuery)})" content="API KEY详情" style="font-size:20px;font-weight:bold;color:#000;">
      </el-page-header>
    </div>
    <div>

  ...
  <div class="nav-common">
    <div class="nav-common" >
      ...
      <div class="user">
        ...
        <span style="margin-right:100px;color:#8488D1;cursor: pointer;" @click="$router.push({path:'/sdkList'});">开发者工具下载</span>
...
.nav-common{background:#fff;color: #0F0D32; overflow: hidden;}
  ...
  .icon_user_default{display: inline-block;width: 34px;height: 34px;position:absolute; left:-50px;top: -8px;-moz-border-radius: 34px;-webkit-border-radius: 34px;border-radius: 34px;background: #8488D1;text-align: center;line-height: 34px;color: #fff;font-style: normal;}
